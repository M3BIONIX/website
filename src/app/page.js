...
export default function Home() {
  ...
  <button type="button" className="hire flex items-center xs:w-auto xs:px-4 xs:py-2 md:py-4 md:px-5 xs:mx-auto xs:text-center md:mr-[15rem]" >
  <span className="xs:text-sm sm:text-base">Hire Me</span>
